...
public sealed class MatchJsonTests
{
    ...
    private const string DocumentWithAbsentCollectionMembers = """
        {"schemaVersion":3,"authorityVersion":"authority-1","startCommand":{"clientCommandId":"30000000-0000-0000-0000-000000000001","deckId":"20000000-0000-0000-0000-000000000001","fingerprint":"start","startRequestFingerprint":"game-start","cpuPolicy":{"version":3,"difficulty":"Normal","seed":7,"decisionIndex":0,"search":{"rootCandidateLimit":256,"immediateNodeLimit":256,"searchNodeLimit":512,"searchDepthLimit":4,"beamWidth":8}}},"start":{"matchId":{"value":"match"},"seed":{"value":7},"firstDeck":{"owner":{"value":"player"}},"secondDeck":{"owner":{"value":"cpu"}}},"cpuPolicy":{"version":3,"difficulty":"Normal","seed":7,"decisionIndex":0,"search":{"rootCandidateLimit":256,"immediateNodeLimit":256,"searchNodeLimit":512,"searchDepthLimit":4,"beamWidth":8}},"commands":[{"id":{"value":"resign"},"matchId":{"value":"match"},"actor":{"value":"player"},"expectedRevision":{"value":0},"action":{"$command":"resign"}}],"clientCommands":[]}
        """;
    ...
    public async Task NormalizedDocument_WritesTheAbsentCollectionsAsEmptyArrays()
    {
        ...
        json.ShouldBe(
            """
            {"schemaVersion":3,"authorityVersion":"authority-1","startCommand":{"clientCommandId":"30000000-0000-0000-0000-000000000001","deckId":"20000000-0000-0000-0000-000000000001","fingerprint":"start","startRequestFingerprint":"game-start","cpuPolicy":{"version":3,"difficulty":"Normal","seed":7,"decisionIndex":0,"search":{"rootCandidateLimit":256,"immediateNodeLimit":256,"searchNodeLimit":512,"searchDepthLimit":4,"beamWidth":8}}},"start":{"matchId":{"value":"match"},"seed":{"value":7},"firstDeck":{"owner":{"value":"player"},"cards":[]},"secondDeck":{"owner":{"value":"cpu"},"cards":[]}},"cpuPolicy":{"version":3,"difficulty":"Normal","seed":7,"decisionIndex":0,"search":{"rootCandidateLimit":256,"immediateNodeLimit":256,"searchNodeLimit":512,"searchDepthLimit":4,"beamWidth":8}},"commands":[{"id":{"value":"resign"},"matchId":{"value":"match"},"actor":{"value":"player"},"expectedRevision":{"value":0},"choices":[],"action":{"$command":"resign"}}],"clientCommands":[]}
            """
        );
        await Task.CompletedTask;
    }
