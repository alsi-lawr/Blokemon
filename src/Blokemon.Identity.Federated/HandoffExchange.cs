...
/// <summary>
/// The route that exchanges a hand-off code minted for a BlokeBot-hosted tenant. The host names
/// the route in the session policy and in the tenant descriptor, so the client learns it at run
/// time and carries no provider name (D-029).
/// </summary>
public static class HandoffExchange
{
